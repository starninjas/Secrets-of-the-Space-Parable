...
stamina.settings = {
	...
	exhaust_dig = get_setting("exhaust_dig", 6),
	exhaust_place = get_setting("exhaust_place", 10),
	exhaust_move = get_setting("exhaust_move", 2),
	exhaust_jump = get_setting("exhaust_jump", 6),
...
function minetest.do_item_eat(hp_change, replace_with_item, itemstack, player, pointed_thing)
	...
	minetest.sound_play("stamina_eat", {to_player = player:get_player_name(), gain = 1.0})
